...
#   timestamp: 2024-10-28T01:17:27+00:00
...
class ExtraHosts(RootModel[Union[Dict[str, Union[str, List[Any]]], ExtraHosts1]]):
    root: Union[Dict[str, Union[str, List[Any]]], ExtraHosts1]
