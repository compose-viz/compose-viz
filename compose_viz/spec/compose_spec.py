...
#   timestamp: 2025-09-07T01:25:00+00:00
...
class Build(BaseModel):
    ...
    provenance: Optional[Union[str, bool]] = Field(None, description="Add a provenance attestation")
    sbom: Optional[Union[str, bool]] = Field(None, description="Add a SBOM attestation")
